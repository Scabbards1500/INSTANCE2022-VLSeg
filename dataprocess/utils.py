...
if __name__ == '__main__':
    # save_file2csv(r'D:\challenge\data\Instance2022\trainstage\train', 'data/traindata.csv')
    # save_file2csv(r'D:\challenge\data\Instance2022\trainstage\validation', 'data/validata.csv')
